...
import { FaEnvelope, FaLock, FaKey, FaArrowLeft, FaUser, FaExternalLinkAlt, FaIdCard } from "react-icons/fa";
          ...
          <Card className="shadow border-0 rounded-4 overflow-hidden">
            <Card.Body className="p-4">
              ...
              <p className="text-muted text-center small mb-4">
                {step === 1 
                  ? "Enter your details below to receive a secure 6-digit verification code." 
                          ...
                          <div className="mt-2 small">
                            ...
                            {suggestions.map((suggestion, index) => (
                              <button
                                ...
                                className="btn btn-outline-success btn-sm me-1 py-0 px-2 fw-semibold"
